...
public final class AwsKmsMrkAwareMasterKeyProvider
  ...
  public static class Builder implements Cloneable {
     ...
     *
     * @see
     *     KmsMasterKeyProvider.Builder#customRegionalClientSupplier(RegionalClientSupplier)
     */
    ...
    static RegionalClientSupplier clientFactory(
            ConcurrentHashMap<Region, KmsClient> clientCache, Supplier<KmsClientBuilder> builderSupplier) {
  ...
  private AwsKmsMrkAwareMasterKeyProvider(
    ...
    if (!isDiscovery
        && defaultRegion == null
        && keyIds.stream()
            .map(AwsKmsCmkArnInfo::parseInfoFromKeyArn)
