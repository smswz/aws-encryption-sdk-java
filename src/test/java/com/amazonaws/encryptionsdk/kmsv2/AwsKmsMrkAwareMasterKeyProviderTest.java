...
import com.amazonaws.encryptionsdk.kmsv2.AwsKmsMrkAwareMasterKey;
import com.amazonaws.encryptionsdk.kmsv2.AwsKmsMrkAwareMasterKeyProvider;
...
public class AwsKmsMrkAwareMasterKeyProviderTest {
  ...
  public static class AwsKmsMrkAwareMasterKeyProviderBuilderTests {
    ...
    public void basic_credentials_and_builder() {
      AwsBasicCredentials creds = AwsBasicCredentials.create("asdf", "qwer");
      StaticCredentialsProvider.create(creds);
      AwsKmsMrkAwareMasterKeyProvider.builder()
          .builderSupplier(() ->
                  KmsClient.builder().credentialsProvider(StaticCredentialsProvider.create(creds)))
          .buildDiscovery();
    }
  }
  ...
  public static class getMasterKey {
    ...
    public void basic_use() {
      final String identifier =
          "arn:aws:kms:us-west-2:111122223333:key/mrk-edb7fe6942894d32ac46dbb1c922d574";
      final KmsClient client = Mockito.spy(new MockKMSClient());
